...
public class RabbitConsumer : IDisposable
{
    ...
    public RabbitConsumer()
    {
        ...
        _model.BasicQosAsync(0, 1, false).GetAwaiter().GetResult();
    }
    ...
    public async Task StartAsync()
    {
        ...
        await _model.BasicConsumeAsync(QueueName, false, consumer);
        ...
        consumer.ReceivedAsync += async (ch, ea) =>
        {
            ...
            await _model.BasicPublishAsync("", ea.BasicProperties.ReplyTo, mandatory: true, replyProperties, messageBuffer);
            await _model.BasicAckAsync(ea.DeliveryTag, false);
        };
    }
