...
while (true)
{
    ...
    if (key.Key == ConsoleKey.Enter)
    {
        ...
        else
        {
            ...
            await sender.SendAsync(message, messageNumber.ToString(CultureInfo.InvariantCulture), ResponseHandler);
...
static void ResponseHandler(IList<string> responses)
{
    Console.WriteLine();
...
static void ProcessKeyStroke(ref int messageNumber, ref ConsoleKeyInfo key)
{
    switch (key.Key)
    {
        case ConsoleKey.D1:
