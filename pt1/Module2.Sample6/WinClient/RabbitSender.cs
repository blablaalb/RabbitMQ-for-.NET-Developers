...
public class RabbitSender : IDisposable
{
    ...
    /// </summary>
    public async Task SetupRabbitMq()
    {
    ...
    public async Task<string> SendAsync(string message, List<string> topics)
    {
        //Setup properties
        ...
        //Send message
        await _channel.BasicPublishAsync(ExchangeName, routingKey, mandatory: true, properties, messageBuffer);
