...
namespace WinClient
{
    public class RabbitSender : IDisposable
    {
        ...
        public async Task SendAsync(string message, Dictionary<string, string> headers)
        {
            //Setup properties
            ...
            //Send message
            await _channel.BasicPublishAsync(ExchangeName, "", mandatory: true, properties, messageBuffer);
        }
